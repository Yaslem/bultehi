import Styles from '@/styles/Congrat.module.css';
export default () => {
    return (
        <div className={Styles.index}>
            ...
            >
                ...
                <rect
                    ...
                    className={Styles.conf7}
                    width={178}
                    height={178}
                />
                <line className={Styles.conf7} x1={76.8} y1={224.7} x2={328.6} y2={224.7} />
                <polyline className={Styles.conf7} points="202.7,350.6 202.7,167.5 202.7,98.9  " />
                <circle className={`${Styles.conf2} ${Styles.b1}`} cx={195.2} cy={232.6} r={5.1} />
                <circle className={`${Styles.conf0} ${Styles.b2}`} cx={230.8} cy={219.8} r={5.4} />
                <circle className={`${Styles.conf0} ${Styles.c2}`} cx={178.9} cy={160.4} r={4.2} />
                <circle className={`${Styles.conf6} ${Styles.d2}`} cx={132.8} cy={123.6} r={5.4} />
                <circle className={`${Styles.conf0} ${Styles.d3}`} cx={151.9} cy={105.1} r={5.4} />
                <path
                    className={`${Styles.conf0} ${Styles.d1}`}
                ...
                />
                <path
                    className={`${Styles.conf6} ${Styles.b5}`}
                ...
                />
                <circle className={`${Styles.conf6} ${Styles.c3}`} cx={206.7} cy={144.4} r={4.5} />
                <path
                    className={`${Styles.conf2} ${Styles.c1}`}
                ...
                />
                <path
                    className={`${Styles.conf2} ${Styles.b4}`}
                ...
                />
                <path
                    className={`${Styles.conf3} ${Styles.c4}`}
                ...
                />
                <path
                    className={`${Styles.conf3} ${Styles.b3}`}
                ...
                />
                <path
                    className={`${Styles.conf3} ${Styles.a2}`}
