...
export default () => {
    ...
    const middle = useSelector(state => state.middle.showStudents);
    ...
    const { data, isError, isLoading } = useSWR(`/middle/year/${year}/schools/${router.query.id}`, fetcher)
    ...
    dispatch(middleActions.setShowStudents(data))
        ...
        <section className={Styles.index}>
            <HeaderPages title={'الصفحة الشخصية للمدرسة'} />
            {
                profile.map((school, key) =>
                    <>
                        <NextSeo
                            title={`بلتيهي - مسابقة ختم الدروس الإعدادية - المدرسة ${school.name}`}
                            openGraph={{
                                title:`بلتيهي - مسابقة ختم الدروس الإعدادية - المدرسة ${school.name}`,
                                description: `معلومات المدرسة ${school.name} في مسابقة ختم الدروس الإعدادية المعروفة بابريفه لسنة ${year}`,
                                url: `middle/schools/${router.query.id}`,
                                type: 'profile',
                                profile: {
                                    ...
                                    }
                                    {
                                        data.next  != null
                                            ? <Pagination
                                                ...
                                                prev={prev}
                                                year={year}
                                                url={`/middle/year/${year}/schools/${router.query.id}`}
